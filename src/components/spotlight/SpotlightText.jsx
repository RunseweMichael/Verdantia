...
const SpotlightText = () => {
  ...
  return (
    <div className="py-3 text-white spotlight-section">
      <div className="container">
        <h2 className="text-success text-center mt-3 mb-4 fw-bold titles">
        ...
        <Tab.Container activeKey={activeKey} onSelect={(k) => setActiveKey(k)}>
          <Nav variant="pills" className="justify-content-center fw-bold mb-4">
            <Nav.Item>
              <Nav.Link eventKey="plant" className="text-success fw-bold explore" style={{fontSize:'1.6rem'}}>
                Plant Details
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="uses" className="text-success fw-bold explore" style={{fontSize:'1.6rem'}}>
                Uses & Benefits
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="facts" className="text-success fw-bold explore" style={{fontSize:'1.6rem'}}>
                Quick Facts
              </Nav.Link>
            </Nav.Item>
          </Nav>
          ...
          <Tab.Content className="bg-dark p-4 rounded shadow text-start border border-success">
            <Tab.Pane eventKey="plant">
              <h4 className="text-success fw-bold spotlight" style={{fontSize:'1.7rem'}}>🌼 Spotlight: Lavender</h4>
              <p className='spotlight-text' style={{fontSize:'1.3rem'}}>
            ...
            <Tab.Pane eventKey="uses">
              ...
              >
                <div>
                  <h4 className="text-success fw-bold spotlight" style={{fontSize:'1.7rem'}}>🌿 How to Use Lavender</h4>
                  <ul style={{fontSize:'1.3rem'}} className="spotlight-text">
            ...
            <Tab.Pane eventKey="facts">
              <div className="d-flex justify-content-around align-items-center sm_spotlight">
                <div>
                  <h4 className="text-success fw-bold spotlight" style={{fontSize:'1.7rem'}}>📌 Fast Facts</h4>
                  <ul style={{fontSize:'1.3rem'}} className="spotlight-text">
                    <li>
